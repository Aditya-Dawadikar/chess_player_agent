...
class SimulationPiece:
    ...
    def get_valid_moves(self, board: 'SimulationBoard') -> List[SimulationSquare]:
...
class SimulationBoard:
    ...
    def make_move(self, from_square: SimulationSquare, to_square: SimulationSquare):
